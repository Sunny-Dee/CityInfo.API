    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public IActionResult GetPointsOfInterest(int cityId)
        {
            try
            {
                ...
                var points = _cityInfoRepository.GetPointsOfInterestsForCity(cityId);
                var cityPois = new List<PointOfInterestDto>();

                foreach (var poi in points)
                {
                    cityPois.Add(new PointOfInterestDto()
                    {
                        Id = poi.Id,
                        Name = poi.Name,
        ...
        public IActionResult GetPointOfInterest(int cityId, int id)
        {
            ...
            var resultPoi = new PointOfInterestDto()
            {
                Id = poi.Id,
                Name = poi.Name,
                Description = poi.Description
            ...
            //var pointOfInterest = city.PointsOfInterest.FirstOrDefault(f => f.Id == id);
